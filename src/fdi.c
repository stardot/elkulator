...
//        printf("Track start %i\n",track);
        ...
        c=fdi2raw_loadtrack(fdih[drive],(uae_u16 *)ftrackinfo[drive][0][0],(uae_u16 *)fditiming,track<<fdisides[drive],&ftracklen[drive][0][0],&ftrackindex[drive][0][0],NULL,0);
        if (!c) memset(ftrackinfo[drive][0][0],0,ftracklen[drive][0][0]);
        c=fdi2raw_loadtrack(fdih[drive],(uae_u16 *)ftrackinfo[drive][0][1],(uae_u16 *)fditiming,track<<fdisides[drive],&ftracklen[drive][0][1],&ftrackindex[drive][0][1],NULL,1);
        if (!c) memset(ftrackinfo[drive][0][1],0,ftracklen[drive][0][1]);
        if (fdisides[drive])
        {
                c=fdi2raw_loadtrack(fdih[drive],(uae_u16 *)ftrackinfo[drive][1][0],(uae_u16 *)fditiming,(track<<fdisides[drive])+1,&ftracklen[drive][1][0],&ftrackindex[drive][1][0],NULL,0);
                if (!c) memset(ftrackinfo[drive][1][0],0,ftracklen[drive][1][0]);
                c=fdi2raw_loadtrack(fdih[drive],(uae_u16 *)ftrackinfo[drive][1][1],(uae_u16 *)fditiming,(track<<fdisides[drive])+1,&ftracklen[drive][1][1],&ftrackindex[drive][1][1],NULL,1);
