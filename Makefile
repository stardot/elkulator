...
ACLOCAL = ${SHELL} /home/mesa/cycleelk/test/missing --run aclocal-1.11
ALLEGRO_CONFIG = /usr/local/bin/allegro-config
AMTAR = ${SHELL} /home/mesa/cycleelk/test/missing --run tar
AUTOCONF = ${SHELL} /home/mesa/cycleelk/test/missing --run autoconf
AUTOHEADER = ${SHELL} /home/mesa/cycleelk/test/missing --run autoheader
AUTOMAKE = ${SHELL} /home/mesa/cycleelk/test/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/mesa/cycleelk/test/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = elkulator
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/mesa/cycleelk/test
abs_srcdir = /home/mesa/cycleelk/test
abs_top_builddir = /home/mesa/cycleelk/test
abs_top_srcdir = /home/mesa/cycleelk/test
ac_ct_CC = gcc
ac_ct_CXX = g++
allegro_CFLAGS = -I/usr/local/include
allegro_LIBS = -L/usr/local/lib -Wl,--export-dynamic -lalleg-4.2.3 -lalleg_unsharable
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/mesa/cycleelk/test/install-sh
